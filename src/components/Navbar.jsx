      ...
      <div className="flex flex-wrap items-center justify-between gap-5 w-full">
        ...
        <div className="flex max-lg:ml-auto space-x-4">
          ...
          <button onClick ={logout}
            className="px-4 py-2 text-sm rounded-full font-medium cursor-pointer tracking-wide text-white border border-blue-600 bg-blue-600 hover:bg-blue-700 transition-all">Logout
            </button>
